...
urlpatterns = [
    ...
    path('adminprofile_update/<int:id>', AdminProfileUpdateView.as_view(), name='admin_profile_update'),
    path('studentprofile/', StudentprofileView.as_view(), name='studentprofile'),
    path('student_profile_update/<int:id>', StudentProfileUpdateView.as_view(), name='student_profile_update'),
